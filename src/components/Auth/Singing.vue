  ...
  <div>
      ...
      <div class="header-section">
        <div id="logoAndNav" class="container-fluid">
          ...
          <nav class="navbar navbar-expand header-navbar">
            <!-- White Logo -->
            <a class="d-none d-lg-flex navbar-brand header-navbar-brand" href="../landings/index.html"
               aria-label="Front">
            ...
            <a class="d-flex d-lg-none navbar-brand header-navbar-brand header-navbar-brand-collapsed"
               href="../landings/index.html" aria-label="Front">
              <!--<img src="../../assets/svg/logos/logo.svg" alt="Logo">xxxxxxxxxxxxxxxxxxxxxxxxxx-->
            </a>
            <!-- End Default Logo -->
    ...
    <main id="content" role="main">
      ...
      <div class="d-flex align-items-center position-relative vh-lg-100">
        <div class="col-lg-5 col-xl-4 d-none d-lg-flex align-items-center bg-navy vh-lg-100 px-0"
             style="background-image: url(../../assets/svg/components/abstract-shapes-20.svg);">
          <div class="w-100 p-5">
            <!-- SVG Quote -->
            ...
            <div id="testimonialsNavMain" class="js-slick-carousel slick mb-4"
              ...
              <div class="js-slide">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-auto">
                  <blockquote class="h3 text-white font-weight-normal mb-4">The template is really nice and offers quite
                    a large set of options. Thank you!
                  </blockquote>
              ...
              <div class="js-slide">
                <!-- Testimonials -->
                <div class="w-md-80 w-lg-60 text-center mx-auto">
                  <blockquote class="h3 text-white font-weight-normal mb-4">It's beautiful and the coding is done
                    quickly and seamlessly. Keep it up!
                  </blockquote>
              ...
              <div class="js-slide">
                <!-- Testimonials -->
                <div class="w-md-80 w-lg-60 text-center mx-auto">
                  <blockquote class="h3 text-white font-weight-normal mb-4">I love Front! I love the ease of use, I love
                    the fact that I have total creative freedom...
                  </blockquote>
            ...
            <div id="testimonialsNavPagination"
              ...
              <div class="js-slide">
                <div class="avatar avatar-circle mx-auto">
                  <!--<img class="avatar-img" src="../../assets/img/100x100/img1.jpg" alt="Image Description">xxxxxxxxxxxxxxxxxxxxxxxxxx-->
                </div>
              </div>

              <div class="js-slide">
                <div class="avatar avatar-circle mx-auto">
                  <!--<img class="avatar-img" src="../../assets/img/100x100/img3.jpg" alt="Image Description">xxxxxxxxxxxxxxxxxxxxxxxxxx-->
                </div>
              </div>
            ...
            <div class="position-absolute right-0 bottom-0 left-0 text-center p-5">
              ...
              <div class="d-flex justify-content-center">
                <!--<img class="max-w-10rem mx-auto" src="../../assets/svg/clients-logo/slack-white.svg"
                     alt="Image Description">
                <img class="max-w-10rem mx-auto" src="../../assets/svg/clients-logo/google-white.svg"
                     alt="Image Description">
                <img class="max-w-10rem mx-auto" src="../../assets/svg/clients-logo/spotify-white.svg"
                     alt="Image Description">-->
              </div>
            </div>
            <!-- End Clients -->
            ...
            <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-top-3 space-lg-0">
              ...
              <form class="js-validate">
                ...
                <div class="js-form-message form-group">
                  ...
                  <input type="email" class="form-control" name="email" id="signinSrEmail" tabindex="1"
